	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'slide-up-fade': 'slideUpAndFade 0.3s ease-out',
				'slide-down-fade': 'slideDownAndFade 0.3s ease-out',
			...
			boxShadow: {
				...
				'elevation-low': '0 1px 2px 0 rgba(0, 0, 0, 0.04)',
				'elevation-medium': '0 2px 4px 0 rgba(0, 0, 0, 0.04), 0 4px 6px -1px rgba(0, 0, 0, 0.07)',
				'elevation-high': '0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 10px 15px -3px rgba(0, 0, 0, 0.05)',
			}
		}
	},
